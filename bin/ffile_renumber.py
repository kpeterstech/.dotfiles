...
class Renumber():
    ...
    def __init__(self, file_prefix, path):
        """Variables that __init__ creates:
            count - the initial count that will be used when renaming files
            prefix - what will be added to the front of all renumber_files
            path - the path where the renumbering will begin to take place"""
